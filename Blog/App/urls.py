...
from .views import HomeView, loginPagina, registroPagina, usuarioEdicion, cambioPassword, hoodiesList, camisasList, zapatosList, pantalonesList, boxersList, pulserasList, gorrasList, hoodiesDetail, camisasDetail, zapatosDetail, pantalonesDetail, boxersDetail, pulserasDetail, gorrasDetail, hoodiesUpdate, camisasUpdate, zapatosUpdate, pantalonesUpdate, boxersUpdate, pulserasUpdate, gorrasUpdate, hoodiesDelete, camisasDelete, zapatosDelete, pantalonesDelete, boxerDelete, pulserasDelete, gorrasDelete, crearPrenda, comentarioPagina
